...
const consentText =
  "By signing up, you agree to receive PCO Ready updates. You can ask to be removed by contacting support@pcoready.co.uk.";
...
export async function newsletterSignupAction(
  ...
  if (error) {
    if (error.code === "23505") {
      return {
        status: "success",
        message: "You are already on the PCO Ready update list."
      };
    }
  ...
  return {
    status: "success",
    message: "Thanks - you're on the PCO Ready update list."
  };
}
