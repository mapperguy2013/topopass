...
export const CURATED_REAL_LONDON_OVERPASS_FIXTURES: CuratedRealLondonOverpassFixtureMetadata[] = [
  ...
  },
  {
    ...
    source: "OpenStreetMap via Overpass export",
    importDate: "2026-07-13T21:07:45Z",
    ...
    knownLimitations: [
      ...
      "This lightweight source export carries one-way and access metadata but no turn restriction relations.",
      "A bounded building-only Overpass supplement is context-only and does not add route nodes or road segments."
    ],
    fixtureBudget: {
      totalElements: 64123,
      nodes: 47846,
      ...
      relations: 27,
      roadSegments: 8914,
      approximateRenderedFeatureCount: 18031,
      directedEdges: 14602,
      contextFeatures: 9447,
      labelCandidates: 1540,
      maxRoadSegments: 10000,
      maxApproximateRenderedFeatureCount: 20000,
      maxBetaPracticeElements: CURATED_REAL_LONDON_BETA_PRACTICE_MAX_ELEMENTS
    },
    visibleInBeta: false,
    scoreable: false,
